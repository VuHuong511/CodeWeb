...
var connectionString = builder.Configuration.GetConnectionString("CodeWEBContextConnection");;

builder.Services.AddDbContext<CodeWEBContext>(options =>
    options.UseSqlServer(connectionString));;

builder.Services.AddDefaultIdentity<CodeWEBUser>(options => options.SignIn.RequireConfirmedAccount = true)
    .AddRoles<IdentityRole>()
    .AddEntityFrameworkStores<CodeWEBContext>();;
