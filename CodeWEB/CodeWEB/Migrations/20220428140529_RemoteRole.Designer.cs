...
{
    [DbContext(typeof(CodeWEBContext))]
    [Migration("20220428140529_RemoteRole")]
    partial class RemoteRole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeWEB.Areas.Identity.Data.CodeWEBUser", b =>
                {
            ...
            modelBuilder.Entity("CodeWEB.Models.Order", b =>
                {
                    b.HasOne("CodeWEB.Areas.Identity.Data.CodeWEBUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CodeWEB.Areas.Identity.Data.CodeWEBUser", null)
                        .WithMany()
